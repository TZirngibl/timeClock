...
<div class="modal_container" id="managermodal_container">
    <div class="modal">
        <p id="registerform">Create  New  Manager</p>
            <form method="post" action="Create/registermanagerdata.php" class="register-form">
                ...
                <input id="registermanager" type="submit" name="register" value="Create New Manager"/> 
            </form>
...
<div class="modal_container" id="usermodal_container">
    <div class="modal">
        <p id="registerform">Create  New  Employee</p>
            <form method="post" action="Create/registeruserdata.php" class="register-form">
                <input type="text"      name="name"     placeholder="Your Name"/>
                    <input type="text"      name="email"    placeholder="E-mail Address"/>
                    ...
                    <input id="registeruser" type="submit" name="register" value="Create New Employee"/> 
            </form>
